...
import id.ac.polbeng.riskiafendi.sqliteexample.databinding.ItemListStudentBinding
...
class StudentAdapter (private val studentList:ArrayList<StudentModel>):
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListViewHolder {
        ...
        val binding =ItemListStudentBinding.inflate(LayoutInflater.from(parent.context),
                parent, false)
